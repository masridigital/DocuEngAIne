 ...
 */
const builtInCompactProviders: IntegrationProvider[] = ['Halo', 'NinjaOne', 'Cipp', 'Meraki', 'UniFi', 'Action1', 'Autotask', 'Blackpoint', 'DefensX']
...
export function IntegrationsPage() {
  ...
  return (
    <div className="page">
      <h1>Integrations</h1>
      <p>
        StackJack Compact is built in. Pick a provider — Halo, NinjaOne, CIPP, Meraki, UniFi, Action1, Autotask, Blackpoint or DefensX — and give the
